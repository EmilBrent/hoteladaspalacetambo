...
import com.example.alumno.hoteladaspalace.fragmnets.AboutUsFragment;
import com.example.alumno.hoteladaspalace.fragmnets.ProductsFragment;
...
public class MenuActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Toast.makeText(this, "has hehco lcik", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_slideshow) {
fragmentChange("produc-list");
