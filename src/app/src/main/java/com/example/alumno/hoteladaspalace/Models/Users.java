...
public class Users {
    ...
    public Users(String _username, String _first_name, String _last_name) {
        this.username = _username;
        this.first_name = _first_name;
        this.last_name = _last_name;
    }

    public static void sync(QueueObject o, final String _username,final AccountFragment _interface) {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if ( response.has("data") ) {
                            ...
                            if (object_response != null) {
                                try {
                                    Users userCloud = new Users(object_response.getString("username"),
